...
`GEM_MIRROR` (optional) lets `entrypoint.sh` route RubyGems through a mirror (full URL including credentials, useful behind a TLS-intercepting proxy). Leave it unset to use rubygems.org directly.
